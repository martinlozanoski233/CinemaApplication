...
namespace Cinema.Web.Controllers
{
    public class TicketsController : Controller
    {
        ...
        public IActionResult Create([Bind("Id,MovieTitle,Date,Time,Seat,Price")] Ticket ticket)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Edit(Guid id, [Bind("Id,MovieTitle,Date,Time,Seat,Price")] Ticket ticket)
        {
            _logger.LogInformation("User Request -> Update Tickets in DataBase!");
